...
class DefaultBuildTreeModelControllerServices : BuildTreeModelControllerServices {
    ...
    class SharedBuildTreeScopedServices {
        fun createIntermediateToolingModelProvider(buildOperationExecutor: BuildOperationExecutor, buildModelParameters: BuildModelParameters): IntermediateToolingModelProvider {
            val runner = IntermediateBuildActionRunner(buildOperationExecutor, buildModelParameters, "Tooling API intermediate model")
            return DefaultIntermediateToolingModelProvider(runner)
        }
    }
