...
@NonNullApi
public class DefaultTypeAwareProblemBuilder extends DelegatingBasicProblemBuilder implements TypeAwareProblemBuilder {
    ...
    public DefaultTypeAwareProblemBuilder(BasicProblemBuilder problemBuilder) {
