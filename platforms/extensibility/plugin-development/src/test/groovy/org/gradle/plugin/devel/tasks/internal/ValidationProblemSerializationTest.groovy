...
class ValidationProblemSerializationTest extends Specification {
    ...
    InternalProblemReporter problemReporter = new DefaultProblemReporter(Stub(ProblemEmitter), [], "gradle")
    ...
    def "can serialize and deserialize a validation problem"() {
        ...
        def deserialized = ValidationProblemSerialization.parseMessageList(json, problemReporter)
    ...
    def "can serialize and deserialize a validation problem with a location"() {
        ...
        when:
        def json = gson.toJson([problem])
        def deserialized = ValidationProblemSerialization.parseMessageList(json, (InternalProblemReporter) problemReporter)
